 ...
 * @description 山脉数组的峰顶索引 852 https://leetcode-cn.com/problems/peak-index-in-a-mountain-array/
 * @createTime 2021-06-15  14:23
 **/
public class PeakIndexInMountainArray852 {
    public static void main(String[] args) {
        PeakIndexInMountainArray852 obj = new PeakIndexInMountainArray852();
