...
//        ConcurrentHashMap<String, List<String>> autoCompleteIndex = new ConcurrentHashMap<>();
//        autoCompleteIndex.computeIfPresent("a",s->new ArrayList<>()).add("1");
    }
