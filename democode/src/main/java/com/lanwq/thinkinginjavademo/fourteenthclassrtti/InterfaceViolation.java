package com.lanwq.thinkinginjavademo.fourteenthclassrtti;//: typeinfo/InterfaceViolation.java
...
public class InterfaceViolation {
  ...
  public static void main(String[] args) {
     ...
     * 可以使用RTTI来判断是哪个类。这个完全合法和可接受的，但是你也许并不想让客户端程序员这么做，因为这给了一个
     ...
     查看类{@link com.lanwq.thinkinginjavademo.fourteenthclassrtti.packageaccess.HiddenC }*/
    if(a instanceof B) {
