 ...
 * @className PrintUtil
 * @description TODO
 * @createTime 2020-12-07  16:32
 **/
public class PrintUtil {
    public static void main(String[] args) throws Exception {
        String pdfFile = "D:\\Bonus point deduction report.pdf";//文件路径
    ...
    public static void PDFPrint(File file, String printerName) throws Exception {
        ...
        try {
            ...
            if (printerName != null) {
                ...
                PrintService printService = ServiceUI.printDialog(null, 300, 300,
                        printServices, printer, DocFlavor.SERVICE_FORMATTED.PAGEABLE, pars);
